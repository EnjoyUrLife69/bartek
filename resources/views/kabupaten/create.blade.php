                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form action="{{route('kabupaten.store')}}" method="post" role="form" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <label>Nama Kabupaten</label>
                                                    <input class="form-control" name="nama_kabupaten" placeholder="Nama Kabupaten">
                                                </div>
                                                {{-- <div class="form-group">
                                                    <label>Selects</label>
