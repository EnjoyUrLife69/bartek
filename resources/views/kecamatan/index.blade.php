                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('kabupaten.index')}}"><i class="fa fa-dashboard fa-fw"></i> Data Kabupaten</a>
                            </li>
                            <li>
                                <a href="{{route('kecamatan.index')}}"><i class="fa fa-dashboard fa-fw"></i> Data Kecamatan</a>
                            </li>
